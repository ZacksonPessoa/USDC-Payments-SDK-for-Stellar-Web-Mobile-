...
4. **Test**: Run `npm test`.
5. **Pack**: Run `npm pack`. This generates a `.tgz` file (e.g., `zacksonpessoa-usdc-payments-sdk-0.3.3-mvp.tgz`).
6. **Commit & Tag**:
   - `git commit -am "chore: release v0.3.3-mvp"`
   - `git tag v0.3.3-mvp`
   - `git push && git push --tags`
7. **Create GitHub Release**:
   - Go to Releases -> Draft a new release.
   - Select tag `v0.3.3-mvp`.
   - Title: `v0.3.3-mvp`.
